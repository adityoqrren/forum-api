...
describe('UserRepositoryPostgres', () => {
  ...
  describe('verifyAvailableUsername function', () => {
    it('should throw InvariantError when username not available', async () => {
      ...
      // Action & Assert
      await expect(userRepositoryPostgres.verifyAvailableUsername('dicoding')).rejects.toThrow(new InvariantError('username tidak tersedia'));
    });
  ...
  describe('getPasswordByUsername', () => {
    it('should throw InvariantError when user not found', async () => {
      ...
      await expect(userRepositoryPostgres.getPasswordByUsername('dicoding'))
        .rejects
        .toThrow(new InvariantError('username tidak ditemukan'));
    });
  ...
  describe('getIdByUsername', () => {
    it('should throw InvariantError when user not found', async () => {
      ...
      await expect(userRepositoryPostgres.getIdByUsername('dicoding'))
        .rejects
        .toThrow(new InvariantError('user tidak ditemukan'));
    });
